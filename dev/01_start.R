...
golem::fill_desc(
  pkg_name = "wcdmx", # The Name of the package containing the App 
  pkg_title = "wcdmx", # The Title of the package containing the App 
  pkg_description = "An app to find toilets in CDMX", # The Description of the package containing the App 
  ...
  repo_url = "https://github.com/alberto-mateos-mo/wcdmx" # The (optional) URL of the GitHub Repo
)     
...
usethis::use_ccby_license(name = "David Mateos")  # You can set another licence here
